...
<%@page import="org.openmrs.module.cfl.CfldistributionGlobalParameterConstants" %>
...
<%
        boolean showStacktrace = Boolean.parseBoolean(Context
                .getAdministrationService()
                .getGlobalProperty(CfldistributionGlobalParameterConstants.CFL_SHOW_STACKTRACE_IN_ERROR_PAGE_KEY));

        if (showStacktrace && exception != null) {
            out.println("<a href=\"#\" onclick=\"showOrHide()\" id=\"toggleLink\" style=\"font-size: 12px;\"></a>");
            out.println("<br/>");
            out.println("<div id=\"stackTrace\">");
            ...
            if (userContext != null && userContext.getAuthenticatedUser() != null) {
                ...
                pageContext.setAttribute("reportBugUrl", Context
                        .getAdministrationService()
